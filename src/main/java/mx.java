...
public class mx extends td {
    ...
    public void a(pa pa1) {
        //TODO: update
        if(ChatProcessor.processChat(pa1.a))
            System.out.println("chatmsg (cap): "+pa1.a);
        else if (ChatHook.runhooks(pa1.a))
            System.out.println("chatmsg (hook): "+pa1.a);
        else
        {
            System.out.println("chatmsg: "+pa1.a);
            f.v.a(pa1.a);
        }
    }
